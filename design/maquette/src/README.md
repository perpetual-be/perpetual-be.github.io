...
- `check.mjs` → vérifications automatiques (premier écran à 1440 × 900 et 1366 × 703, débordement horizontal, effet de chaque bascule, Φ de l'en-tête, logos partenaires, photo 2800 px, mode présentation, page sans JavaScript, polices, contrastes).
